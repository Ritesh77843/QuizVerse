...
export default function LiveGameDashboard() {
  ...
  const { session, setSession, gameState, waitingPlayers, currentQuestion, leaderboard, timer, setGameControls, questionEnded, correctOptionId, showScoreboard, setShowScoreboard, clearGame } = useGameStore();
    ...
    return (
      <div className="min-h-screen relative overflow-hidden flex flex-col"
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6">
          ...
          {/* Waiting pill */}
          <motion.div
            className={`px-8 py-3 rounded-xl font-bold text-xl shadow-xl ${isLocked
        ...
        <div className="relative z-10 flex items-center justify-between px-8 pb-8">
          ...
          <div className="flex items-center gap-3">
            <motion.button
              ...
              className={`flex items-center gap-2 font-bold px-6 py-4 rounded-2xl text-lg transition-all border-2 ${isLocked
                ...
                {leaderboard?.entries.map((entry, i) => {
                  ...
                  return (
                    <motion.div key={entry.nickname}
                      ...
                      className={`relative flex items-center gap-6 p-3 rounded-2xl shadow-lg border-b-4 transition-colors duration-1000 ${isTop ? 'bg-gradient-to-r from-lime-500 to-green-600 border-green-700 shadow-[0_0_20px_rgba(132,204,22,0.4)] z-10 ring-2 ring-lime-300'
